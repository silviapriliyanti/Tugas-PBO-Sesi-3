...
public class Mahasiswa21A extends Mahasiswa{
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < tot_data; i++) {
            ...
            System.out.println("===============================");
            Mahasiswa21A dina = new Mahasiswa21A(nim, nama, nilai);
            daftar.add(dina);
            if (dina.isLulus()) {
                tot_lulus++;
                nm_lulus += nama + ", ";
            ...
            if (dina.getGradeGG() == 'A') {
                nil_a++;
                nm_a += nama + ", ";
            } else if (dina.getGradeGG() == 'B') {
                nil_b++;
                nm_b += nama + ", ";
            } else if (dina.getGradeGG() == 'C') {
                nil_c++;
                nm_c += nama + ", ";
            } else if (dina.getGradeGG() == 'D') {
                nil_d++;
                nm_d += nama + ", ";
            } else if (dina.getGradeGG() == 'E') {
                nil_e++;
                nm_e += nama + ", ";
            }
            tot_nilai += nilai;
